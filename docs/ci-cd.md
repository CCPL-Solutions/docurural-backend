...
|-------------------------------|-----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| `ci.yml`                        | Push a `feature/**`, `bugfix/**`, `hotfix/**`; PR hacia `develop`, `main`, `release/**`, `hotfix/**`         | `mvn verify` (incluye el gate de cobertura JaCoCo); publica el reporte de pruebas como artefacto.                        |
