...
public record LoginResponseDto(
    ...
    public static LoginResponseDto bearer(String token, long expiresInSeconds, UserSummaryDto user) {
        return new LoginResponseDto(token, "Bearer", expiresInSeconds, user);
    }
}
